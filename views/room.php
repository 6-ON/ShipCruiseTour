...
<div class=" sm:mx-12 overflow-x-auto relative shadow-md sm:rounded-lg">
    ...
    <div id="deleteModal" tabindex="-1" aria-hidden="true"
        ...
        <div class="relative p-4 w-full max-w-md h-full md:h-auto">
            ...
            <div class="relative p-4 text-center bg-white rounded-lg shadow dark:bg-gray-800 sm:p-5">
                ...
                <form action="/roomDelete" method="post" class="flex justify-center items-center space-x-4">
...
<div id="reserveModal" tabindex="-1" aria-hidden="true"
    ...
    <div class="relative p-4 w-full max-w-md h-full md:h-auto">
        ...
        <div class="relative p-4 text-center bg-white rounded-lg shadow dark:bg-gray-800 sm:p-5">
            ...
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" class="text-gray-400 dark:fill-gray-500 w-11 h-11 mb-3.5 mx-auto" >
