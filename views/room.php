...
<div class=" sm:mx-12 mx-2 overflow-x-auto relative shadow-md sm:rounded-lg">
    <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
        ...
        <tr class="bg-white border-b dark:bg-gray-900 dark:border-gray-700">
            ...
            <td class="py-4 px-6 flex gap-8">
                <button data-modal-toggle="reserveModal" value="4" class="reserve-btn font-semibold text-green-600 dark:text-green-500 hover:underline">Reserve</button>
                <?php if (true): ?>
